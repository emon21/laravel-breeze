            ...
            <aside class="w-64 " aria-label="Sidebar">
                <div class="overflow-y-auto py-4 px-3 bg-gray-50 rounded dark:bg-gray-800">
                    <ul class="space-y-2">
                        <li>
                            <a href="#"
                                class="flex items-center p-2 text-base font-normal text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-white-700">
            ...
            <section class="bg-white dark:bg-gray-900">
                <div class="py-8 px-4 sm:py-16 lg:px-6">
                    <div class=" mb-8 lg:mb-16">
                        <h1 class="text-center text-4xl border-b-2">Wellcome To Dashboard</h1>
                        ...
                        <p class="text-gray-500 sm:text-xl dark:text-gray-400">Here at Flowbite we focus on markets
                    ...
                    <div class="space-y-8 md:grid md:grid-cols-2 lg:grid-cols-3 md:gap-12 md:space-y-0">
                        ...
                        <div>
                            ...
                            <p class="text-gray-500 dark:text-gray-400">Auto-assign tasks, send Slack messages, and
                                much
                        ...
                        <div>
                            ...
                            <p class="text-gray-500 dark:text-gray-400">Craft beautiful, delightful experiences for
                                both
